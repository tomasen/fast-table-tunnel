...
func PacketStart(builder *flatbuffers.Builder) { builder.StartObject(8) }
...
func PacketAddProperties(builder *flatbuffers.Builder, properties uint16) { builder.PrependUint16Slot(6, properties, 0) }
func PacketAddContent(builder *flatbuffers.Builder, content flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(content), 0) }
