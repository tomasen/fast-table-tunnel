...
func (rcv *Packet) DstNode() uint64 {
...
func (rcv *Packet) DstAddress() string {
...
func (rcv *Packet) DstNetwork() string {
...
func PacketStart(builder *flatbuffers.Builder) { builder.StartObject(11) }
...
func PacketAddDstNode(builder *flatbuffers.Builder, dstNode uint64) { builder.PrependUint64Slot(3, dstNode, 0) }
func PacketAddSrcNode(builder *flatbuffers.Builder, srcNode uint64) { builder.PrependUint64Slot(4, srcNode, 0) }
func PacketAddDstAddress(builder *flatbuffers.Builder, dstAddress flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(dstAddress), 0) }
func PacketAddDstNetwork(builder *flatbuffers.Builder, dstNetwork flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(dstNetwork), 0) }
func PacketAddRouteList(builder *flatbuffers.Builder, routeList flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(routeList), 0) }
...
func PacketAddCommand(builder *flatbuffers.Builder, command uint16) { builder.PrependUint16Slot(8, command, 0) }
func PacketAddProperties(builder *flatbuffers.Builder, properties uint16) { builder.PrependUint16Slot(9, properties, 0) }
func PacketAddContent(builder *flatbuffers.Builder, content flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(content), 0) }
